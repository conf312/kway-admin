...
public class Member extends BaseTime {
    ...
    public static class Response implements UserDetails{
        ...
        public Response(Long id, String name, String email, String password, String role, int loginFailCount, LocalDateTime lastLoginTime, String isAccountNonLocked, String isCredentialsNonExpired, String isEnabled, String ip, String saveFileName, String webPath, Long fileId) {
            this.id = id;
            this.name = name;
            this.email = email;
            this.password = password;
